...
local bg = require("binding.global")
local bc = require("binding.client")
RC.bindings = {
	globalkeys = bg.keys,
...
--------------------------------------------------
--- backups
--- all variables the default config expect to exist that are being removed as it gets modularized
--------------------------------------------------

local modkey = RC.vars.modkey
local mylauncher = RC.mainmenu.launcher
